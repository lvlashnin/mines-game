...
export const Cell = (props: CellProps) => {
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      className={cn(
        "relative min-w-0 aspect-square rounded-lg flex items-center justify-center transition-all duration-200",
    ...
    >
      ...
      >
        ...
        <span className="absolute text-2xl sm:text-4xl pointer-events-none -z-10">
          ...
          {(state === UI_CELL_STATE.MINE || state === UI_CELL_STATE.MINE_HIT) &&
            "💣"}
        </span>
      </div>
    </button>
